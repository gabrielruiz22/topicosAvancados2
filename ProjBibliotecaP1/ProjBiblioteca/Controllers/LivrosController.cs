...
namespace ProjBibliotecaWeb.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public LivrosController(ProjBibliotecaWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeDoLivro,Disponivel")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeDoLivro,Disponivel")] Livro livro)
        {
            if (id != livro.Id)
            {
                return NotFound();
