...
namespace ProjBibliotecaWeb.Controllers
{
    public class AutoresController : Controller
    {
        ...
        public AutoresController(ProjBibliotecaWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeAutor,quantidadeLivrosPublicados")] Autor autor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeAutor,quantidadeLivrosPublicados")] Autor autor)
        {
            if (id != autor.Id)
            {
                return NotFound();
